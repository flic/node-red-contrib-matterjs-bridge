...
// By default we filter out just those two known-noisy prefixes; all other console.debug output is
// preserved. Set MATTERJS_WS_DEBUG=1 to opt out and let the raw frames/events through (debugging).
